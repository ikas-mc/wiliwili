...
void VideoView::setDashUrl(int start, int end, std::string videoUrl, std::string videoIndexRange, std::string videoInitRange, std::string audioUrl, std::string audioIndexRange, std::string audioInitRange) {
